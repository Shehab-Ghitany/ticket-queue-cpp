...
public:
	...
	void PrintInfo()
	{
		...
		cout << endl << string (4,'\t') << "Queue Info";
		cout << endl << Spaces() << endl;
		cout << endl << string(3,'\t') << "    Prefix   = " << _Prefix;
		cout << endl << string(3, '\t') << "    Total  Tickets   = " << _TotalTickets;
		cout << endl << string(3, '\t') << "    Served  Clients  = " << ServedClients();
		cout << endl << string(3, '\t') << "    Waiting Clients  = " << WaitingClients();
